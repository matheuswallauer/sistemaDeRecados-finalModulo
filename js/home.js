...
function salvarNaTabela(recado, indice) {
  ...
  novoRecado.innerHTML = `<tr class="tr-recados">

  <td class="titulo-td">
  ${recado.tituloRecado}
  </td>
  <td class="descricao-td">
  ${recado.descricaoRecado}
  </td>
  <td>
  <button class="btn-editar-recados" id= ${indice} name = "editar">Editar</button>
  <button class="btn-apagar-recados" id=${indice} name = "apagar">Apagar</button>
  </td>
  </tr>`;
  document.querySelector("#tbody > tr").appendChild(novoRecado);
}
...
const botoesAcoes = document.querySelector("#tbody > tr");
